...
export function GeneratedPassword() {
    const copyGeneratedPassword = () => {
        console.log('estou chamando o copy generate');
    }
    return (
